...
import { Component, ViewEncapsulation, ChangeDetectionStrategy, Input, ElementRef, Directive, Inject, NgModule } from '@angular/core';
import * as i1 from '@taiga-ui/core';
import { tuiDropdownOptionsProvider, TuiHintDirective, tuiHintOptionsProvider, TuiScrollbarModule } from '@taiga-ui/core';
...
TuiHeaderComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: TuiHeaderComponent, selector: "header[tuiNavigationHeader]", host: { attributes: { "tuiTheme": "night" } }, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: TuiHintAsideDirective, decorators: [{
            ...
            args: [{
                    ...
                    type: Inject,
                    args: [ElementRef]
                }] }, { type: TuiAsideComponent, decorators: [{
                    type: Inject,
                    args: [TuiAsideComponent]
                }] }, { type: i1.TuiHintDirective, decorators: [{
                    type: Inject,
...
TuiLogoComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: TuiLogoComponent, selector: "[tuiNavigationLogo]", ngImport: i0, template: '<ng-content></ng-content>', isInline: true, styles: ["[tuiNavigationLogo]{display:flex;align-items:center;grid-gap:.5rem;gap:.5rem;overflow:hidden;white-space:nowrap;font-weight:bold}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
...
TuiNavigationModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: TuiNavigationModule, declarations: [TuiHeaderComponent,
        TuiHintAsideDirective,
        TuiLogoComponent,
        TuiMainComponent,
        TuiAsideComponent,
        TuiNavComponent], imports: [CommonModule, TuiScrollbarModule, TuiFadeModule], exports: [TuiHeaderComponent,
        TuiHintAsideDirective,
        TuiLogoComponent,
        TuiMainComponent,
        TuiAsideComponent,
...
export { TuiAsideComponent, TuiHeaderComponent, TuiHintAsideDirective, TuiLogoComponent, TuiMainComponent, TuiNavComponent, TuiNavigationModule };
