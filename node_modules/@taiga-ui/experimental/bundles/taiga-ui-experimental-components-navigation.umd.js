(function (global, factory) {
    ...
    var TuiHintAsideDirective = /** @class */ (function () {
        function TuiHintAsideDirective(el, aside, hint) {
            this.el = el;
            this.aside = aside;
            this.hint = hint;
        }
        TuiHintAsideDirective.prototype.ngDoCheck = function () {
            var _a;
            this.hint.tuiHint = this.aside.tuiNavigationAside
                ? ''
                : (_a = this.el.nativeElement.textContent) === null || _a === void 0 ? void 0 : _a.trim();
        };
        return TuiHintAsideDirective;
    }());
    TuiHintAsideDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiHintAsideDirective, deps: [{ token: i0.ElementRef }, { token: TuiAsideComponent }, { token: i1.TuiHintDirective }], target: i0__namespace.ɵɵFactoryTarget.Directive });
    TuiHintAsideDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.2.17", type: TuiHintAsideDirective, selector: "[tuiHint][tuiHintAside]", providers: [i1.tuiHintOptionsProvider({ direction: 'right' })], ngImport: i0__namespace });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiHintAsideDirective, decorators: [{
                type: i0.Directive,
                args: [{
                        selector: '[tuiHint][tuiHintAside]',
                        providers: [i1.tuiHintOptionsProvider({ direction: 'right' })],
                    }]
            ...
            return [{ type: i0__namespace.ElementRef, decorators: [{
                        ...
                        }] }, { type: i1__namespace.TuiHintDirective, decorators: [{
                            type: i0.Inject,
                            args: [i1.TuiHintDirective]
                        }] }];
        } });
    ...
    exports.TuiHintAsideDirective = TuiHintAsideDirective;
