(function (global, factory) {
	...
	Object.keys(avatarLabeled).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return avatarLabeled[k]; }
		});
	});
	Object.keys(avatarStack).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
	...
	Object.keys(badgeNotification).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return badgeNotification[k]; }
		});
	});
	...
	Object.keys(status).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return status[k]; }
		});
	});
	Object.keys(swipeAction).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return swipeAction[k]; }
		});
	});
	Object.keys(thumbnailCard).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return thumbnailCard[k]; }
		});
	});
...
//# sourceMappingURL=taiga-ui-experimental-components.umd.js.map
