(function (global, factory) {
        ...
        var TuiCardMediumDirective = /** @class */ (function () {
            function TuiCardMediumDirective(directiveStyles) {
                directiveStyles.addComponent(TuiCardComponent);
            }
            return TuiCardMediumDirective;
        }());
        TuiCardMediumDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiCardMediumDirective, deps: [{ token: i1.TuiDirectiveStylesService }], target: i0__namespace.ɵɵFactoryTarget.Directive });
        TuiCardMediumDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.2.17", type: TuiCardMediumDirective, selector: "[tuiCardMedium]", host: { attributes: { "tuiCardMedium": "" } }, ngImport: i0__namespace });
        i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiCardMediumDirective, decorators: [{
                    type: i0.Directive,
                    args: [{
        ...
        var TuiCardLargeDirective = /** @class */ (function () {
            function TuiCardLargeDirective(directiveStyles) {
                this.space = 'normal';
                directiveStyles.addComponent(TuiCardComponent);
            }
            return TuiCardLargeDirective;
        }());
        TuiCardLargeDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiCardLargeDirective, deps: [{ token: i1.TuiDirectiveStylesService }], target: i0__namespace.ɵɵFactoryTarget.Directive });
        TuiCardLargeDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.2.17", type: TuiCardLargeDirective, selector: "[tuiCardLarge]", inputs: { space: ["tuiCardLarge", "space"] }, host: { attributes: { "tuiCardLarge": "" }, properties: { "attr.data-space": "space || \"normal\"" } }, ngImport: i0__namespace });
        i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiCardLargeDirective, decorators: [{
                    type: i0.Directive,
                    args: [{
        ...
        TuiCardModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiCardModule, declarations: [TuiCardComponent, TuiCardLargeDirective, TuiCardMediumDirective], exports: [TuiCardLargeDirective, TuiCardMediumDirective] });
        ...
        exports.TuiCardLargeDirective = TuiCardLargeDirective;
        exports.TuiCardMediumDirective = TuiCardMediumDirective;
