(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@taiga-ui/cdk/exceptions'), require('@taiga-ui/cdk/utils/miscellaneous'), require('@taiga-ui/cdk/constants'), require('@taiga-ui/cdk/utils'), require('@taiga-ui/cdk/utils/focus')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/cdk/observables', ['exports', 'rxjs', 'rxjs/operators', '@taiga-ui/cdk/exceptions', '@taiga-ui/cdk/utils/miscellaneous', '@taiga-ui/cdk/constants', '@taiga-ui/cdk/utils', '@taiga-ui/cdk/utils/focus'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].cdk = global["taiga-ui"].cdk || {}, global["taiga-ui"].cdk.observables = {}), global.rxjs, global.rxjs.operators, global["taiga-ui"].cdk.exceptions, global["taiga-ui"].cdk.utils.miscellaneous, global["taiga-ui"].cdk.constants, global["taiga-ui"].cdk.utils, global["taiga-ui"].cdk.utils.focus));
})(this, (function (exports, rxjs, operators, exceptions, miscellaneous, constants, utils, focus) { 'use strict';

    /**
     * Turns AbstractControl/Abstract-control-directive valueChanges into ReplaySubject(1)
     */
    function tuiControlValue(control) {
        return new rxjs.Observable(function (subscriber) { var _a; return (_a = control === null || control === void 0 ? void 0 : control.valueChanges) === null || _a === void 0 ? void 0 : _a.pipe(operators.startWith(control.value)).subscribe(subscriber); });
    }
