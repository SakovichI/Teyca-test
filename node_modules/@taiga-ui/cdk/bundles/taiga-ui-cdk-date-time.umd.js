    ...
    ***************************************************************************** */
    ...
    var TuiDay = /** @class */ (function (_super) {
        ...
        TuiDay.normalizeParse = function (rawDate, dateMode) {
            if (dateMode === void 0) { dateMode = 'DMY'; }
            var _b = this.parseRawDateString(rawDate, dateMode), day = _b.day, month = _b.month, year = _b.year;
        ...
        TuiDay.jsonParse = function (yearMonthDayString) {
            var _b = this.parseRawDateString(yearMonthDayString, 'YMD'), day = _b.day, month = _b.month, year = _b.year;
         ...
         */
        TuiDay.prototype.append = function (_b) {
            var _c = _b.year, year = _c === void 0 ? 0 : _c, _d = _b.month, month = _d === void 0 ? 0 : _d, _e = _b.day, day = _e === void 0 ? 0 : _e;
            var totalMonths = (this.year + year) * MONTHS_IN_YEAR + this.month + month;
    ...
    var TuiTime = /** @class */ (function () {
        function TuiTime(hours, minutes, seconds, ms) {
            ...
            ngDevMode &&
                ...
                Number.isInteger(hours) &&
                    math.tuiInRange(hours, 0, Infinity) &&
                    Number.isInteger(minutes) &&
                    math.tuiInRange(minutes, 0, MINUTES_IN_HOUR) &&
                    Number.isInteger(seconds) &&
                    math.tuiInRange(seconds, 0, SECONDS_IN_MINUTE) &&
                    Number.isInteger(ms) &&
                    math.tuiInRange(ms, 0, 1000), 'Time must be real, but got:', hours, minutes, seconds, ms);
        }
        /**
        ...
        TuiTime.prototype.shift = function (_a) {
            ...
            var totalMs = this.toAbsoluteMilliseconds() +
                hours * MILLISECONDS_IN_HOUR +
                minutes * MILLISECONDS_IN_MINUTE +
                seconds * MILLISECONDS_IN_SECOND +
                ms;
            var totalSeconds = Math.floor(totalMs / MILLISECONDS_IN_SECOND);
            var totalMinutes = Math.floor(totalSeconds / SECONDS_IN_MINUTE);
            var totalHours = Math.floor(totalMinutes / MINUTES_IN_HOUR);
        ...
        TuiTime.prototype.normalizeToRange = function (value, modulus) {
    ...
    exports.MAX_DISPLAYED_YEAR = MAX_DISPLAYED_YEAR;
    ...
    exports.TUI_LAST_DISPLAYED_DAY = TUI_LAST_DISPLAYED_DAY;
