...
function tuiControlValue(control) {
    return new Observable(subscriber => { var _a; return (_a = control === null || control === void 0 ? void 0 : control.valueChanges) === null || _a === void 0 ? void 0 : _a.pipe(startWith(control.value)).subscribe(subscriber); });
}
