...
export declare class TuiOptionComponent<T = unknown> implements OnDestroy {
    ...
    disabled: boolean;
    value?: T;
    constructor(isMobile: boolean, content: PolymorpheusContent<TuiContextWithImplicit<TemplateRef<Record<string, unknown>>>> | null, dataList: TuiDataListComponent<T> | null, el: ElementRef<HTMLElement>, host: TuiDataListHost<T> | null, dropdown: TuiDropdownDirective | null, icons: TuiCommonIcons);
    get active(): boolean;
    onClick(): void;
    onMouseMove({ currentTarget }: TuiEventWith<MouseEvent, HTMLElement>): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<TuiOptionComponent<any>, [null, { optional: true; }, { optional: true; }, null, { optional: true; }, { optional: true; self: true; }, null]>;
