...
import { ElementRef, Injectable, Inject, Component, ChangeDetectionStrategy, Self, HostListener, HostBinding, inject, Directive, NgModule } from '@angular/core';
...
const TUI_DIALOG_CLOSE_BUTTON_DARK = 'tui-dialog-close-button-dark';
...
export { TUI_DIALOGS_CLOSE, TUI_DIALOG_CLOSE_BUTTON_DARK, TUI_DIALOG_DEFAULT_OPTIONS, TUI_DIALOG_OPTIONS, TuiDialogCloseService, TuiDialogComponent, TuiDialogDirective, TuiDialogModule, TuiDialogService, tuiDialogOptionsProvider };
