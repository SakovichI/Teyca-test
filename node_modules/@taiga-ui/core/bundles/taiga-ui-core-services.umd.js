(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var TuiVisualViewportService = /** @class */ (function () {
        ...
        TuiVisualViewportService.prototype.correct = function (_c) {
            var _d = __read(_c, 2), y = _d[0], x = _d[1];
            return [this.correctY(y), this.correctX(x)];
        };
        TuiVisualViewportService.prototype.correctX = function (x) {
            var _a, _b;
            return this.isWebkit ? x + ((_b = (_a = this.win.visualViewport) === null || _a === void 0 ? void 0 : _a.offsetLeft) !== null && _b !== void 0 ? _b : 0) : x;
        };
        TuiVisualViewportService.prototype.correctY = function (y) {
            var _a, _b;
