(function (global, factory) {
...
})(this, (function (exports, i0, abstract, i1, i2, operators, i1$1, i3, miscellaneous, ngEventPlugins, i5, i6) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiDropdownOpenMonitorDirective = /** @class */ (function () {
        function TuiDropdownOpenMonitorDirective(destroy$, hosted, dropdown, open) {
            ...
            if ((open === null || open === void 0 ? void 0 : open.dropdown) === dropdown) {
                open.tuiDropdownOpenChange.pipe(operators.takeUntil(destroy$)).subscribe(function (value) {
                    var _a;
                    if (value) {
        ...
        Object.defineProperty(TuiDropdownOpenMonitorDirective.prototype, "tuiDropdownOpenMonitor", {
            set: function (open) {
                var _a;
    ...
    TuiDropdownOpenMonitorDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.2.17", type: TuiDropdownOpenMonitorDirective, selector: "[tuiDropdownOpenMonitor]", inputs: { tuiDropdownOpenMonitor: "tuiDropdownOpenMonitor" }, providers: [i1.TuiDestroyService], ngImport: i0__namespace });
    ...
    TuiHostedDropdownComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiHostedDropdownComponent, deps: [{ token: i3.TuiDropdownHoverDirective, optional: true, self: true }, { token: i0.ElementRef }], target: i0__namespace.ɵɵFactoryTarget.Component });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiHostedDropdownComponent, decorators: [{
            ...
            return [{ type: i3__namespace.TuiDropdownHoverDirective, decorators: [{
                            type: i0.Self
                        }, {
                            type: i0.Optional
                        }, {
                            type: i0.Inject,
                            args: [i3.TuiDropdownHoverDirective]
    ...
    TuiHostedDropdownModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiHostedDropdownModule, declarations: [TuiAccessorProxyDirective,
            ...
            i3.TuiDropdownModule], exports: [TuiHostedDropdownComponent,
            TuiHostedDropdownConnectorDirective,
            i3.TuiDropdownOptionsDirective] });
