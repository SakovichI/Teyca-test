(function (global, factory) {
    ...
    var TUI_SCROLLBAR_OPTIONS = i1.tuiCreateToken(TUI_DEFAULT_SCROLLBAR_OPTIONS);
    function tuiScrollbarOptionsProvider(options) {
        return i1.tuiProvideOptions(TUI_SCROLLBAR_OPTIONS, options, TUI_DEFAULT_SCROLLBAR_OPTIONS);
    }

    // TODO: Remove all legacy code in 4.0
    var TuiScrollbarComponent = /** @class */ (function () {
        function TuiScrollbarComponent(cssRef, el, userAgent, isIos, options) {
            this.cssRef = cssRef;
            this.el = el;
    ...
    TuiScrollbarComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiScrollbarComponent, deps: [{ token: common.CSS }, { token: i0.ElementRef }, { token: common.USER_AGENT }, { token: i1.TUI_IS_IOS }, { token: TUI_SCROLLBAR_OPTIONS }], target: i0__namespace.ɵɵFactoryTarget.Component });
    ...
    exports.TUI_DEFAULT_SCROLLBAR_OPTIONS = TUI_DEFAULT_SCROLLBAR_OPTIONS;
    exports.TUI_SCROLLBAR_OPTIONS = TUI_SCROLLBAR_OPTIONS;
    ...
    exports.tuiScrollbarOptionsProvider = tuiScrollbarOptionsProvider;
