(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var TuiDropdownComponent = /** @class */ (function () {
        function TuiDropdownComponent(vvs, position$, destroy$, directive, animation, el, accessor, win, mode$, options, hoverDirective) {
            ...
            position$
                ...
                if (_this.directive.el.nativeElement.isConnected) {
                    _this.update(top, left);
                }
                else {
                    _this.directive.toggle(false);
                }
            });
    ...
    var TuiDropdownContextDirective = /** @class */ (function (_super) {
        ...
        TuiDropdownContextDirective.prototype.onTouchStart = function (x, y) {
            ...
            this.longTapTimeout = setTimeout(function () {
                _this.currentRect = i2.tuiPointToClientRect(x, y);
    ...
    TuiDropdownContextDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiDropdownContextDirective, deps: [{ token: i2.TuiActiveZoneDirective }, { token: i2.TUI_IS_IOS }, { token: i2.TUI_IS_TOUCH }], target: i0__namespace.ɵɵFactoryTarget.Directive });
    ...
    var TuiDropdownSelectionDirective = /** @class */ (function (_super) {
        ...
        function TuiDropdownSelectionDirective(range, doc, selection$, el, vcr, dropdown) {
            ...
            _this.stream$ = i1.combineLatest([
                _this.handler$,
                _this.selection$.pipe(operators.map(function () { return _this.getRange(); }), operators.distinctUntilChanged(function (x, y) { return x.startOffset === y.startOffset &&
