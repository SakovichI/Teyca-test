(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function tuiFallbackAccessor(type) {
        return function (accessors, fallback) { return (accessors === null || accessors === void 0 ? void 0 : accessors.find(function (accessor) { return accessor !== fallback && accessor.type === type; })) ||
            fallback; };
    }
    ...
    function tuiPositionAccessorFor(type, fallback) {
        return {
            ...
            deps: fallback
                ? [[new i0.SkipSelf(), new i0.Optional(), TuiPositionAccessor], fallback]
                : [[new i0.SkipSelf(), new i0.Optional(), TuiPositionAccessor]],
    ...
    function tuiRectAccessorFor(type, fallback) {
        return {
            ...
            deps: [[new i0.SkipSelf(), new i0.Optional(), TuiRectAccessor], fallback],
            useFactory: tuiFallbackAccessor(type),
        };
    }
    ...
    exports.tuiFallbackAccessor = tuiFallbackAccessor;
