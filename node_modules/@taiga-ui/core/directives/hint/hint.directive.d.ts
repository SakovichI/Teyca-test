...
export declare class TuiHintDirective<C> implements OnDestroy, TuiPortalItem<C>, TuiRectAccessor, TuiVehicle {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<TuiHintDirective<any>, "[tuiHint]:not(ng-container):not(ng-template)", never, { "tuiHint": "tuiHint"; "context": "tuiHintContext"; "tuiHintAppearance": "tuiHintAppearance"; }, {}, never>;
}
