...
export declare class TuiInputCardGroupedComponent extends AbstractTuiInputCard<TuiCard, TuiInputCardGroupedOptions> implements TuiFocusableElementAccessor, TuiDataListHost<Partial<TuiCard>> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TuiInputCardGroupedComponent, "tui-input-card-grouped", never, { "exampleText": "exampleText"; "cardValidator": "cardValidator"; "cvcHidden": "cvcHidden"; "codeLength": "codeLength"; }, { "autofilledChange": "autofilledChange"; }, ["dropdown", "datalist"], never>;
}
