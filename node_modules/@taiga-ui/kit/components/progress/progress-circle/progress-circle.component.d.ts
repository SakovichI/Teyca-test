...
import { TuiProgressOptions } from '../progress.options';
...
export declare class TuiProgressCircleComponent {
    ...
    readonly animationDelay$: Observable<boolean>;
    constructor(userAgent: string, win: Window, el: ElementRef<HTMLElement>, mode$: Observable<TuiBrightness | null>, options: TuiProgressOptions);
