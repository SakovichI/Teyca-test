(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@maskito/core'), require('@maskito/kit'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/constants'), require('@taiga-ui/kit/tokens'), require('rxjs/operators'), require('@taiga-ui/kit/directives'), require('@maskito/angular'), require('@tinkoff/ng-polymorpheus'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/input-date', ['exports', '@angular/core', '@angular/forms', '@maskito/core', '@maskito/kit', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/constants', '@taiga-ui/kit/tokens', 'rxjs/operators', '@taiga-ui/kit/directives', '@maskito/angular', '@tinkoff/ng-polymorpheus', '@angular/common', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].kit = global["taiga-ui"].kit || {}, global["taiga-ui"].kit.components = global["taiga-ui"].kit.components || {}, global["taiga-ui"].kit.components["input-date"] = {}), global.ng.core, global.ng.forms, global.core, global.kit, global.i2, global.i1, global["taiga-ui"].kit.constants, global["taiga-ui"].kit.tokens, global.rxjs.operators, global["taiga-ui"].kit.directives, global.i4, global.i5, global.ng.common, global.rxjs));
})(this, (function (exports, i0, i8, core, kit, i2, i1, constants, tokens, operators, i3, i4, i5, i6, i9) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiInputDateComponent = /** @class */ (function (_super) {
        ...
        function TuiInputDateComponent(control, cdr, isMobile, mobileCalendar, dateFormat, dateSeparator, dateTexts$, valueTransformer, options, textfieldSize) {
        ...
        Object.defineProperty(TuiInputDateComponent.prototype, "computedActiveYearMonth", {
            get: function () {
                var _a, _b;
                var clampedDate = i2.tuiDateClamp(this.defaultActiveYearMonth, this.computedMin, this.computedMax);
                if ((_a = this.value) === null || _a === void 0 ? void 0 : _a.dayAfter(i2.TUI_LAST_DISPLAYED_DAY)) {
        ...
        Object.defineProperty(TuiInputDateComponent.prototype, "computedMask", {
            get: function () {
                 ...
                 * https://github.com/taiga-family/maskito/issues/604
                 */
                var nativeValueIsNotSynced = this.nativeValue !== this.computedValue;
        ...
        TuiInputDateComponent.prototype.onValueChange = function (value) {
            ...
            this.value =
                value.length !== i2.DATE_FILLER_LENGTH || this.activeItem
                    ? null
    ...
    TuiInputDateComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: TuiInputDateComponent, selector: "tui-input-date:not([multiple])", inputs: { min: "min", max: "max", disabledItemHandler: "disabledItemHandler", markerHandler: "markerHandler", items: "items", defaultActiveYearMonth: "defaultActiveYearMonth" }, host: { listeners: { "click": "onClick()" }, properties: { "attr.data-size": "this.size" } }, providers: [
            ...
            tokens.tuiDateStreamWithTransformer(tokens.TUI_DATE_VALUE_TRANSFORMER),
            {
                ...
                useFactory: function () { return (i0.inject(i2.TUI_IS_MOBILE) &&
                    i0.inject(tokens.TUI_MOBILE_CALENDAR, i2.InjectFlags.Optional)) ||
                    i0.inject(i1.TUI_DROPDOWN_COMPONENT, i2.InjectFlags.SkipSelf); },
            },
    ...
    TuiInputDateDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.2.17", type: TuiInputDateDirective, selector: "tui-input-date:not([multiple])", providers: [i1.tuiAsTextfieldHost(TuiInputDateDirective)], usesInheritance: true, ngImport: i0__namespace });
