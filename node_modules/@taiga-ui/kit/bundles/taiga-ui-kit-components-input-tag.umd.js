(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/providers'), require('@tinkoff/ng-polymorpheus'), require('rxjs'), require('rxjs/operators'), require('@taiga-ui/kit/components/tag'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/input-tag', ['exports', '@angular/core', '@angular/forms', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/providers', '@tinkoff/ng-polymorpheus', 'rxjs', 'rxjs/operators', '@taiga-ui/kit/components/tag', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].kit = global["taiga-ui"].kit || {}, global["taiga-ui"].kit.components = global["taiga-ui"].kit.components || {}, global["taiga-ui"].kit.components["input-tag"] = {}), global.ng.core, global.ng.forms, global.i4, global.i1, global["taiga-ui"].kit.providers, global.i5, global.rxjs, global.rxjs.operators, global["taiga-ui"].kit.components.tag, global.ng.common));
})(this, (function (exports, i0, i6, i4, i1, providers, i5, i7, operators, i2, i3) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiInputTagComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(TuiInputTagComponent.prototype, "tagsEmpty", {
            get: function () {
                var _a, _b;
        ...
        TuiInputTagComponent.prototype.onInput = function (value) {
            ...
            if (array.length > 1) {
                var invalid = tags.filter(function (tag) { return _this.disabledItemHandler(tag); });
                var search = invalid.length
                    ? invalid.join(i4.tuiIsString(this.separator) ? this.separator : ',')
                    : '';
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiInputTagComponent, decorators: [{
            ...
            return [{ type: i6__namespace.NgControl, decorators: [{
                    ...
                    type: i0.ContentChild,
                    args: [i5.PolymorpheusOutletDirective]
                }], errorIconTemplate: [{
                    type: i0.ViewChild,
                    args: ['errorIcon']
                }], size: [{
