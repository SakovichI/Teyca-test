(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var TuiInputTimeComponent = /** @class */ (function (_super) {
        ...
        function TuiInputTimeComponent(control, cdr, timeTexts$, options, isMobile, isIos, textfieldSize, valueTransformer) {
            ...
            _this.open = false;
            _this.identityMatcher = function (controlValue, dropdownValue) { return controlValue instanceof i2.TuiTime &&
        ...
        TuiInputTimeComponent.prototype.checkOption = function (option) {
            var _a;
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiInputTimeComponent, decorators: [{
            ...
            return [{ type: i7__namespace.NgControl, decorators: [{
                            ...
                            type: i0.Inject,
                            args: [tokens.TUI_TIME_VALUE_TRANSFORMER]
                        }] }];
