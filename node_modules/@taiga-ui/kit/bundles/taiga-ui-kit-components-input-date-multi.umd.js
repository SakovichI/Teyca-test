(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@maskito/kit'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/classes'), require('@taiga-ui/kit/components/input-tag'), require('@taiga-ui/kit/tokens'), require('@taiga-ui/kit/utils'), require('rxjs/operators'), require('@maskito/angular'), require('@tinkoff/ng-polymorpheus'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/input-date-multi', ['exports', '@angular/core', '@angular/forms', '@maskito/kit', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/classes', '@taiga-ui/kit/components/input-tag', '@taiga-ui/kit/tokens', '@taiga-ui/kit/utils', 'rxjs/operators', '@maskito/angular', '@tinkoff/ng-polymorpheus', '@angular/common', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].kit = global["taiga-ui"].kit || {}, global["taiga-ui"].kit.components = global["taiga-ui"].kit.components || {}, global["taiga-ui"].kit.components["input-date-multi"] = {}), global.ng.core, global.ng.forms, global.kit, global.i6, global.i1, global["taiga-ui"].kit.classes, global["taiga-ui"].kit.components["input-tag"], global["taiga-ui"].kit.tokens, global["taiga-ui"].kit.utils, global.rxjs.operators, global.i3, global.i5, global.ng.common, global.rxjs));
})(this, (function (exports, i0, i4, kit, i6, i1, classes, i2, tokens, utils, operators, i3, i5, i7, i8) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiInputDateMultiComponent = /** @class */ (function (_super) {
        ...
        function TuiInputDateMultiComponent(control, cdr, isMobile, mobileCalendar, dateFormat, dateSeparator, dateTexts$, valueTransformer, options, textfieldSize, doneWord$) {
            var _this = this;
            var _a, _b;
            ...
            _this.tagValidator = function (tag) {
                ...
                return ((_c = (i6.TuiDay.isValidDay(year, month, day) &&
                    ((_a = _this.min) === null || _a === void 0 ? void 0 : _a.daySameOrBefore(date)) &&
                    ((_b = _this.max) === null || _b === void 0 ? void 0 : _b.daySameOrAfter(date)))) !== null && _c !== void 0 ? _c : false);
            };
    ...
    TuiInputDateMultiComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: TuiInputDateMultiComponent, selector: "tui-input-date[multiple]", inputs: { min: "min", max: "max", disabledItemHandler: "disabledItemHandler", markerHandler: "markerHandler", defaultActiveYearMonth: "defaultActiveYearMonth", expandable: "expandable", inputHidden: "inputHidden", search: "search", placeholder: "placeholder", rows: "rows", tagValidator: "tagValidator" }, host: { listeners: { "click": "onClick()" }, properties: { "attr.data-size": "this.size" } }, providers: [
            ...
            tokens.tuiDateStreamWithTransformer(tokens.TUI_DATE_VALUE_TRANSFORMER),
            {
                ...
                useFactory: function () { return (i0.inject(i6.TUI_IS_MOBILE) &&
                    i0.inject(tokens.TUI_MOBILE_CALENDAR, i6.InjectFlags.Optional)) ||
                    i0.inject(i1.TUI_DROPDOWN_COMPONENT, i6.InjectFlags.SkipSelf); },
            },
