(function (global, factory) {
    ...
    var TuiPrimitiveCalendarRangeComponent = /** @class */ (function () {
        ...
        TuiPrimitiveCalendarRangeComponent.prototype.ngOnChanges = function (_a) {
            var defaultViewedMonthFirst = _a.defaultViewedMonthFirst, defaultViewedMonthSecond = _a.defaultViewedMonthSecond;
            if (!this.value) {
        ...
        TuiPrimitiveCalendarRangeComponent.prototype.updateViewedMonths = function (firstMonth, secondMonth) {
            if (this.value) {
