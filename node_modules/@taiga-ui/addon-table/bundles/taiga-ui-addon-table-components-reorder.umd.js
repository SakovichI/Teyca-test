(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/addon-table/tokens'), require('@taiga-ui/cdk'), require('@taiga-ui/kit'), require('@taiga-ui/core'), require('@angular/common'), require('@tinkoff/ng-polymorpheus'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/addon-table/components/reorder', ['exports', '@angular/core', '@taiga-ui/addon-table/tokens', '@taiga-ui/cdk', '@taiga-ui/kit', '@taiga-ui/core', '@angular/common', '@tinkoff/ng-polymorpheus', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"]["addon-table"] = global["taiga-ui"]["addon-table"] || {}, global["taiga-ui"]["addon-table"].components = global["taiga-ui"]["addon-table"].components || {}, global["taiga-ui"]["addon-table"].components.reorder = {}), global.ng.core, global["taiga-ui"]["addon-table"].tokens, global.cdk, global.i1, global.i2, global.ng.common, global.i4, global.rxjs));
})(this, (function (exports, i0, tokens, cdk, i1, i2, i3, i4, i5) { 'use strict';
    ...
    TuiReorderModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiReorderModule, declarations: [TuiReorderComponent], imports: [i3.CommonModule,
            i2.TuiSvgModule,
            i2.TuiButtonModule,
            i1.TuiTilesModule,
            i4.PolymorpheusModule], exports: [TuiReorderComponent] });
    TuiReorderModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiReorderModule, imports: [[
                i3.CommonModule,
                i2.TuiSvgModule,
                i2.TuiButtonModule,
                i1.TuiTilesModule,
