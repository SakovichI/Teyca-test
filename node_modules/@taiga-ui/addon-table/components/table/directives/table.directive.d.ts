...
export declare class TuiTableDirective<T extends Partial<Record<keyof T, any>>> extends AbstractTuiController implements AfterViewInit {
    ...
    constructor(entries$: Observable<IntersectionObserverEntry[]>, mode$: Observable<TuiBrightness | null>, stuck$: Observable<boolean>, options: TuiTableOptions, cdr: ChangeDetectorRef, directiveStyles: TuiDirectiveStylesService);
