...
export declare class TuiThComponent<T extends Partial<Record<keyof T, any>>> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TuiThComponent<any>, "th[tuiTh]", never, { "sorter": "sorter"; "resizable": "resizable"; "sticky": "sticky"; "requiredSort": "requiredSort"; }, {}, never, ["*"]>;
}
