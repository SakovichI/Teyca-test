...
export declare class TuiReorderComponent<T> {
    ...
    content: PolymorpheusContent<TuiContextWithImplicit<T> & {
        index: number;
    }>;
    noop(): void;
    onDrag(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TuiReorderComponent<any>, "tui-reorder", never, { "items": "items"; "enabled": "enabled"; "content": "content"; }, { "itemsChange": "itemsChange"; "enabledChange": "enabledChange"; }, never, never>;
}
