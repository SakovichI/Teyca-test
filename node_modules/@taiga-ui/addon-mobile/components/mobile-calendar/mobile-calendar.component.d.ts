...
export declare class TuiMobileCalendarComponent implements AfterViewInit {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<TuiMobileCalendarComponent, [null, null, null, { self: true; }, null, null, null, null, null, null, { optional: true; }, null, null]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<TuiMobileCalendarComponent, "tui-mobile-calendar", never, { "single": "single"; "multi": "multi"; "min": "min"; "max": "max"; "disabledItemHandler": "disabledItemHandler"; "value": "value"; }, { "cancel": "cancel"; "confirm": "confirm"; "valueChange": "valueChange"; }, never, never>;
}
