(function (global, factory) {
	...
	Object.keys(mobileCalendar).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return mobileCalendar[k]; }
		});
	});
	Object.keys(mobileCalendarDialog).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return mobileCalendarDialog[k]; }
		});
	});
	Object.keys(mobileDialog).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return mobileDialog[k]; }
		});
	});
	Object.keys(pullToRefresh).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return pullToRefresh[k]; }
		});
	});
	...
	Object.keys(sheetDialog).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return sheetDialog[k]; }
		});
	});
	...
	Object.keys(themeAndroid).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return themeAndroid[k]; }
		});
	});
	Object.keys(themeIos).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return themeIos[k]; }
		});
	});
...
//# sourceMappingURL=taiga-ui-addon-mobile-components.umd.js.map
