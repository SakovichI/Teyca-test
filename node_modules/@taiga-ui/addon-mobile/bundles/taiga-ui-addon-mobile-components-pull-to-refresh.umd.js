(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"]["addon-mobile"] = global["taiga-ui"]["addon-mobile"] || {}, global["taiga-ui"]["addon-mobile"].components = global["taiga-ui"]["addon-mobile"].components || {}, global["taiga-ui"]["addon-mobile"].components["pull-to-refresh"] = {}), global.ng.core, global.i1, global.i1$1, global.rxjs, global.ng.common, global.rxjs.operators, global.i1$2));
})(this, (function (exports, i0, i1, i1$1, i3, i2, operators, i1$2) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var EXCLUSION_SELECTORS = 'tui-dialog, tui-dropdown, tui-sheet-dialog, tui-dropdown-mobile';
    var TuiPullToRefreshService = /** @class */ (function (_super) {
        ...
        function TuiPullToRefreshService(el, scrollRef, loaded$, threshold, component) {
            ...
            _this.touched = false;
            _this.pulling$ = _this.loaded$.pipe(operators.startWith(null), operators.switchMap(function () { return i1$1.tuiTypedFromEvent(_this.element, 'touchstart', { passive: true }).pipe(operators.filter(function () { return !_this.scrollTop &&
                !_this.el.nativeElement.querySelector(EXCLUSION_SELECTORS); }), operators.map(function (_a) {
    ...
    TuiPullToRefreshModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: TuiPullToRefreshModule, declarations: [TuiPullToRefreshComponent,
            TuiMobileLoaderAndroidComponent,
            TuiMobileLoaderIOSComponent], imports: [i2.CommonModule,
            i1$2.TuiLoaderModule,
            i1$2.TuiSvgModule,
            i1$1.TuiRepeatTimesModule,
            i1.PolymorpheusModule], exports: [TuiPullToRefreshComponent] });
